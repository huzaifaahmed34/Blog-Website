...
<!-- Content Wrapper. Contains page content -->
 ...
 {{ csrf_field() }}                    <!---Form Start-->
              ...
              <input type="text" class="form-control" id="name" name=category_name placeholder="Enter Category Name" value={{@$category}}>

                </div>
                    </div>
                      <div class="col-lg-6">
                      <div class="form-group">
                   <label>Category Image &nbsp;<span style="color:red;" id=imageerror></span></label>

              <input type="file" class="form-control" id="logo" name=category_logo >
...
$('#form1')[0].reset();
			...
			if(response.error){
if('category_name' in response.error){
  ...
  $('#name').addClass('is-invalid');
      ...
      if('category_logo' in response.error){
